...
from .metrics import calculate_relative_metrics
from .trade_plan import build_trade_plan
from .transform import build_relative_bars


def build_render_snapshot(client: MT5Client, cfg: Settings, symbol_1: str, symbol_2: str, timeframe: str, bars_count: int, ratio_1_to_2: float, use_ratio_in_divergence: bool, bars_per_candle: int) -> RenderSnapshot:
    ...
    return RenderSnapshot(bars=bars, metrics=metrics, divergence_stats=divergence_stats, divergence_series=divergence_series, trade_plan=trade_plan, digits_1=meta_1.digits, digits_2=meta_2.digits)
